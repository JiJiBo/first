...
public interface IBooks extends Serializable {
    ...
    /**
     * Load data from another generated Record/POJO implementing the common interface IBooks
     */
    public void from(com.rulerbug.zoo.tables.interfaces.IBooks from);

    /**
     * Copy data into another generated Record/POJO implementing the common interface IBooks
     */
    public <E extends com.rulerbug.zoo.tables.interfaces.IBooks> E into(E into);
}
